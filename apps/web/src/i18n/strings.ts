...
export const STR: Dict = {
  ...
  cardBrewRecipe: { id: 'RESEP SEDUH', en: 'BREW RECIPE' },
  cardGrinder: { id: 'Gilingan', en: 'Grinder' },
  cardGrind: { id: 'Giling', en: 'Grind' },
  cardDripper: { id: 'Dripper', en: 'Dripper' },
  cardFilter: { id: 'Filter', en: 'Filter' },
  cardRecipe: { id: 'Resep', en: 'Recipe' },
  cardDose: { id: 'DOSIS', en: 'DOSE' },
  cardRatio: { id: 'RASIO', en: 'RATIO' },
  cardWater: { id: 'AIR', en: 'WATER' },
  cardTemp: { id: 'SUHU', en: 'TEMP' },
  cardClicks: { id: 'klik', en: 'clicks' },
  cardIdeal: { id: 'ideal', en: 'ideal' },
  cardCta: { id: 'Racik pour-over-mu  →  menoowel.com', en: 'Dial in your own pour-over  →  menoowel.com' },
